...
set ylabel "Ticks"
set title "Performance of removing an element with different atomic locks (function + acquire + release)"
...
plot \
"../results/latency_ttas.txt" using 1:13 title "TTAS" ls 1 with linespoints, \
"../results/latency_array.txt" using 1:13 title "Array" ls 2 with linespoints, \
"../results/latency_mcs.txt" using 1:13 title "MCS" ls 3 with linespoints, \
"../results/latency_hclh.txt" using 1:13 title "HCLH" ls 4 with linespoints, \
"../results/latency_mutex.txt" using 1:13 title "Mutex" ls 7 with linespoints, \
"../results/latency_hticket.txt" using 1:13 title "HTicket" ls 8 with linespoints, \
"../results/latency_ticket.txt" using 1:13 title "Ticket" ls 6 with linespoints
