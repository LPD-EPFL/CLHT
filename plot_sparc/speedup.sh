...
set title "Speed-up of different atomic locks for get function"
...
plot \
"../results/throughput_ttas.txt" using 1:($2/system("echo $seq")) title "TTAS" ls 1 with linespoints, \
"../results/throughput_array.txt" using 1:($2/system("echo $seq")) title "Array" ls 2 with linespoints, \
"../results/throughput_mcs.txt" using 1:($2/system("echo $seq")) title "MCS" ls 3 with linespoints, \
"../results/throughput_hclh.txt" using 1:($2/system("echo $seq")) title "HCLH" ls 4 with linespoints, \
"../results/throughput_mutex.txt" using 1:($2/system("echo $seq")) title "Mutex" ls 7 with linespoints, \
"../results/throughput_hticket.txt" using 1:($2/system("echo $seq")) title "HTicket" ls 8 with linespoints, \
"../results/throughput_ticket.txt" using 1:($2/system("echo $seq")) title "Ticket" ls 6 with linespoints
