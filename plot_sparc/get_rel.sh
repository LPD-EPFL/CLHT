...
set ylabel "Ticks"
set title "Performance of releasing different atomic locks for get function"
...
plot \
"../results/latency_ttas.txt" using 1:7 title "TTAS" ls 1 with linespoints, \
"../results/latency_array.txt" using 1:7 title "Array" ls 2 with linespoints, \
"../results/latency_mcs.txt" using 1:7 title "MCS" ls 3 with linespoints, \
"../results/latency_hclh.txt" using 1:7 title "HCLH" ls 4 with linespoints, \
"../results/latency_mutex.txt" using 1:7 title "Mutex" ls 7 with linespoints, \
"../results/latency_hticket.txt" using 1:7 title "HTicket" ls 8 with linespoints, \
"../results/latency_ticket.txt" using 1:7 title "Ticket" ls 6 with linespoints
